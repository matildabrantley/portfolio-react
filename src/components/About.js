      ...
      <div className="about lead">
          <h4 className="h4">About Me</h4>
            ...
            <p>
              ...
              include React, MongoDB, Progressive Web Apps, Express/Node, GraphQL, Phaser and AI. My GaTech final project was a 
              solo endeavor bringing together a full MERN stack, game engine and my custom neural network framework that trains agents 
              to quickly solve a myriad of challenges and play most types of games.
            </p>
            <p>
